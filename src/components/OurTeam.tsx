...
function OurTeam() {
    ...
    return (
        <Element name="team">
            <section
                className="w-full bg-black text-white py-20 px-6 lg:px-28 relative"
            ...
            >
                <div className="max-w-7xl mx-auto">
                    ...
                    {/* Custom Arrows */}
                    <button
                        className="custom-prev absolute top-3/5 left-2 md:left-14 z-20 transform -translate-y-1/2 bg-[#B69231] text-black rounded-full p-2 shadow-md hover:text-white transition"
                        aria-label="Previous team member"
                    >
                        <ChevronLeft className="w-6 h-6" aria-hidden="true" />
                    </button>
                    <button
                        className="custom-next absolute top-3/5 right-2 md:right-14 z-20 transform -translate-y-1/2 bg-[#B69231] text-black rounded-full p-2 shadow-md hover:text-white transition"
