...
export default function About() {
    return (
        <section className="relative w-full text-white py-16 md:py-24 px-6 lg:px-12 overflow-hidden">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative z-10">
                ...
                >
                    <h2 className="text-3xl md:text-4xl lg:text-5xl heading">
                        ...
                        <span className="gradient-text relative">
                            AiGentic Group
                            <span className="absolute left-0 -bottom-1 w-full h-[3px] bg-gradient-to-r from-indigo-400 via-purple-500 to-pink-500 rounded-full animate-pulse"></span>
                        </span>
                    </h2>

                    <p className="text-gray-300 text-lg leading-relaxed">
                        AiGentic Group is a holding company specialising in AI-powered
                        financial technology and media brands. We develop companies that
                        leverage artificial intelligence to transform how financial markets
                        operate and communicate.
                    </p>

                    <p className="text-gray-400 text-base md:text-lg leading-relaxed">
                        Our focus is on building a portfolio of synergistic brands that
                        collectively create superior value in the capital markets ecosystem.
                    </p>
                ...
                >
                    <div className="relative w-full max-w-md mx-auto lg:mx-0">
                        {/* glow border */}
                        <div className="absolute -bottom-6 -right-6 w-[95%] h-[95%] rounded-2xl bg-gradient-to-tr from-indigo-500/40 via-purple-600/40 to-pink-500/30 blur-xl animate-pulse-slow"></div>
                        <div className="absolute -bottom-6 -right-6 w-[95%] h-[95%] rounded-2xl bg-gradient-to-r from-indigo-500 to-purple-600 shadow-lg"></div>
